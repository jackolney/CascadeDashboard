####################################################################################################
# PEPFAR PHIA FILE
# Nigeria Cascade Tool Formal Analysis Script
...
quartz.save(file = "../../formal/nigeria/fig/cal/CD4-2010.pdf", type = "pdf")

graphics.off(); quartz.options(w = 8, h = 6)
BuildCD4CalibData_Thesis(year = 6, modelOut = modelOut)
quartz.save(file = "../../formal/nigeria/fig/cal/CD4-2015.pdf", type = "pdf")

# No PHIA for Nigeria
# graphics.off(); quartz.options(w = 9, h = 4)
# BuildPHIAPlot(data = CalibOut)
# quartz.save(file = "../../formal/nigeria/fig/cal/PHIA.pdf", type = "pdf")
...
BuildCalibPlot_Thesis(data = CalibOut,
    ...
    limit = MinNumber)
quartz.save(file = "../../formal/nigeria/fig/cal/cascade-2015.pdf", type = "pdf")
...
BuildCalibrationHistogram_Thesis(
    runError = runError,
    maxError = MaxError)
quartz.save(file = "../../formal/nigeria/fig/cal/calib-hist.pdf", type = "pdf")
...
BuildCalibDetailPlot_Thesis(
    ...
    originalData = MasterData,
    limit = MinNumber)
quartz.save(file = "../../formal/nigeria/fig/cal/calib-detail.pdf", type = "pdf")

# Parameter Histograms
graphics.off(); quartz.options(w = 10, h = 4)
BuildCalibrationParameterHistGroup_Thesis()
quartz.save(file = "../../formal/nigeria/fig/cal/par-hist.pdf", type = "pdf")
...
quartz.save(file = "../../formal/nigeria/fig/cal/calib-data.pdf", type = "pdf")

# save.image("../../formal/nigeria/data.RData")
# Parameter means
...
quartz.save(file = "../../formal/nigeria/fig/pro/cascade-projection.pdf", type = "pdf")
...
# <200
save.image("../../formal/nigeria/data-28-03-17.RData")
# load("../../formal/nigeria/data-24-01-17.RData")
...
# save.image("../../formal/nigeria/data.RData")
# save.image("../../formal/nigeria/big-data.RData")
...
quartz.save(file = "../../formal/nigeria/fig/opt/changes-baseline.pdf", type = "pdf")
